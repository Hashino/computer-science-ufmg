...
void Matrix::inicializaMatrizNula(mat_tipo *mat)
...
void Matrix::criaMatriz(mat_tipo *mat, int tx, int ty, int id)
...
void Matrix::inicializaMatrizAleatoria(mat_tipo *mat)
...
double Matrix::acessaMatriz(mat_tipo *mat)
// Descricao: acessa mat para fins de registro de acesso
// Entrada: mat
// Saida: mat
{
...
void Matrix::imprimeMatriz(mat_tipo *mat)
...
void Matrix::salvaMatriz(mat_tipo *mat, FILE *out)
...
void Matrix::escreveElemento(mat_tipo *mat, int x, int y, double v)
...
double Matrix::leElemento(mat_tipo *mat, int x, int y)
...
void Matrix::copiaMatriz(mat_tipo *src, mat_tipo *dst, int dst_id)
...
void Matrix::somaMatrizes(mat_tipo *a, mat_tipo *b, mat_tipo *c)
...
void Matrix::multiplicaMatrizes(mat_tipo *a, mat_tipo *b, mat_tipo *c)
...
void Matrix::transpoeMatriz(mat_tipo *a)
...
void Matrix::destroiMatriz(mat_tipo *a)
